...
<div class="social-login mb-8">
    ...
    <div class="social-buttons flex gap-3 mb-8">
        <a href="{{ route('login.google') }}" class="social-btn google flex-1 flex items-center justify-center gap-2 px-3.5 py-3 border-2 border-white/20 rounded-lg bg-white/5 text-light font-medium transition-all duration-300 hover:border-red-500 hover:bg-red-500/10 hover:-translate-y-1 hover:shadow-lg backdrop-blur-sm">
        ...
        <a href="{{ route('login.linkedin') }}" class="social-btn linkedin flex-1 flex items-center justify-center gap-2 px-3.5 py-3 border-2 border-white/20 rounded-lg bg-white/5 text-light font-medium transition-all duration-300 hover:border-blue-600 hover:bg-blue-600/10 hover:-translate-y-1 hover:shadow-lg backdrop-blur-sm">
            <svg class="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
