...
<section class="sessions-hero">
    <div class="ath-container">
        <div class="sessions-hero-content">
            ...
            <p>Join our monthly panel discussions with industry experts, mentors, and learners. Network, learn, and grow with the SkillsCo-op community.</p>
            <a href="#register-section" class="btn btn-primary">Register for Next Session <i class="fas fa-arrow-down"></i></a>
        </div>
    </div>
</section>
    ...
    <div class="ath-container">
        ...
        <div class="details-grid">
            <div class="detail-card">
                ...
                <h3>Expert Panels</h3>
                <p>Hear from industry professionals, data scientists, tech leaders, and educators sharing real-world insights and career advice.</p>
            </div>
            <div class="detail-card">
                <div class="detail-icon"><i class="fas fa-comments"></i></div>
                <h3>Open Q&A</h3>
                <p>Ask questions directly to panelists and get personalized advice on your digital skills journey and career aspirations.</p>
            </div>
            <div class="detail-card">
                    ...
                    <form action="{{ route('sessions.register') }}" method="POST" class="register-form">
                        ...
                        <div class="form-group">
                            ...
                            <select id="referral_source" name="referral_source">
                                ...
                                <option value="search_engine" {{ old('referral_source') == 'search_engine' ? 'selected' : '' }}>Search Engine (Google, etc.)</option>
                                <option value="community_org" {{ old('referral_source') == 'community_org' ? 'selected' : '' }}>Community Organisation</option>
                                <option value="event" {{ old('referral_source') == 'event' ? 'selected' : '' }}>Event / Workshop</option>
...
@media (max-width: 768px) {
    .sessions-hero { padding: 140px 0 80px; }
    .details-grid { grid-template-columns: 1fr; }
    .register-form { padding: 35px 25px; }
}
</style>
@endpush
@endsection
